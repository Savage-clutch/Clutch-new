...
function FinalCTA({ onClick }) {
  ...
  return (
    <section style={{ padding: '100px 0' }}>
      <div ref={ctaRef} className="container-narrow center">
        <img src="assets/shiny-badge.webp" alt="Clutch Certified" style={{ width: 280, display: 'block', margin: '0 auto 32px', filter: 'drop-shadow(0 20px 40px rgba(0,0,0,.2))' }} />
        <h2 className="h-display" style={{ marginBottom: 24 }}>
          Don't want to wait? Shop Clutch Certified
        </h2>
